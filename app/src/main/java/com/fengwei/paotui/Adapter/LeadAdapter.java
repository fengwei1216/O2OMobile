...
import com.fengwei.paotui.Activity.B0_SigninActivity;
import com.fengwei.paotui.Activity.LeadActivity;
...
public class LeadAdapter extends PagerAdapter {
    ...
    public LeadAdapter(Context context, int[] imageBg) {
        ...
        shared =context.getSharedPreferences(PaotuiAppConst.USERINFO, 0);
        editor = shared.edit();
    }
